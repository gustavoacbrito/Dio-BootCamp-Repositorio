...
public class ParImpar {
    public static void main(String[] args) {
        ...
        System.out.println("Os números Pares digitados foram: " + Arrays.toString(numerosPar) + " Totalizando "+ contadorPar + " números pares.");
        System.out.println("Os números Ímpares digitados foram: " + Arrays.toString(numerosImpar) + " Totalizando " + contadorImpar + " números Impares.");
    }
